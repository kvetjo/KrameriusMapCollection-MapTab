...
var UI = React.createClass({
  ...
  manifestUrl() {
    return this.purlUrl()  + '/manifest/';
  },

  purlUrl() {
    return 'https://kramerius.cuni.cz/search/iiif-presentation/' + this.state.mapid;
  },

  urlLinkToKram() {
    return 'http://kramerius.cuni.cz/uuid/' + this.state.mapid;
  },
    ...
    return (
      <div>
        <div className='pin-left pad2 zIndex row2'>
          <a href={this.urlLinkToKram()} target='_blank' title='View at Kramerius' className='icon button share big'></a>
        </div>
